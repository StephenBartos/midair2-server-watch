...
CREATE TABLE IF NOT EXISTS server_list (
    guild_id BIGINT PRIMARY KEY NOT NULL REFERENCES guild(guild_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_notice_feed_last_mention_at ON notice_feed (last_mention_at);
